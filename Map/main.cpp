...
typedef std::pair<const char, foo<int>> T3;
...
void	printReverse(ft::map<char, int> &mp)
{
	//typename 
	ft::map<char, int>::iterator it = mp.end();
	ft::map<char, int>::iterator ite = mp.begin();
...
int     main( void )
{
	...
	std::map<T1, T2>::const_iterator ite(mp.begin());
	printSize(mp);
